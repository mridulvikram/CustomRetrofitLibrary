...
import com.mridul.customretrofitlibrary.Network.APIInterface;
import com.mridul.customretrofitlibrary.Network.NetworkCall;
import com.mridul.customretrofitlibrary.Network.NetworkCallBack;
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.getDataBTN:
                networkCall.NetworkAPICall(API.BASE_URL, API.GET_DATA_API, true);
                break;
            case R.id.sendDataBTN:
                networkCall.NetworkAPICall(API.BASE_URL, API.POST_DATA_API, true);
                break;
        }
    }
}